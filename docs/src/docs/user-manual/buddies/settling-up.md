...
1. On the project page, use the **Pay someone back** form.
2. Select who you want to pay back.
3. Enter the amount you are sending them.
4. Click **Submit**.
...
The project admin can clear all outstanding debts in one go using the simplified debt breakdown.
The big advantage in settling the whole project at once is that each person has to perform
fewer transactions to settle up with everyone. This only works well if everyone settles up at the same time.

1. On the project page, click **Settle entire project**.
