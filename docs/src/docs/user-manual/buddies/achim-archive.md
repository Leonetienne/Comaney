...
Shared expenses are part of your financial record. If you and an offline member split a bill, removing them should not silently erase that bill or change your balances. Achim Archive steps in as a stand-in so the numbers stay correct.
...
Achim Archive collects the shared expense records of every offline member you have removed. If you remove multiple offline members over time, their histories are all folded into the same archive.

## Deleting archived expenses

You can permanently delete the archived expenses at any time. This is a destructive action and cannot be undone.

**For your personal buddy list:**
...
- How many expenses paid by removed members will be deleted permanently.
- How many of your own expenses had the removed members as participants (those expenses stay; only the split record is removed).
- What balance you will lose or be forgiven.

Confirm on that page to delete, or click **Cancel** to go back.

!!! warning
    Deleting archived expenses permanently changes your financial history. Balances and debt records will reflect the world as if those members were never there. This cannot be reversed.
